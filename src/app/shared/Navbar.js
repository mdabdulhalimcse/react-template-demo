...
class Navbar extends Component {
  ...
  logOut() {
    alert('Sorry! You hae been Logged Out!')
    AuthService.logout();
    
  }
  render () {
    return (
      <nav className="navbar default-layout-navbar col-lg-12 col-20 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <Link className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/brand_icons/logo.PNG')} alt="logo" /></Link>
              ...
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link">
                  <div className="nav-profile-img">
                    <img src={require("../../assets/images/faces/face10.jpg")} alt="user"/>
                    <span className="availability-status online"></span>
                  </div>
                  <div className="nav-profile-text">
                    <p className="mb-1 text-black"><Trans>{this.user}</Trans></p>
                  </div>
                </Dropdown.Toggle>
                ...
                <Dropdown.Menu className="navbar-dropdown">
                  ...
                  <Dropdown.Item href="!#" onClick={evt =>evt.preventDefault()}>
                    ...
                    {/* <Trans onClick={this.logOut}>Signout Why</Trans> */}
